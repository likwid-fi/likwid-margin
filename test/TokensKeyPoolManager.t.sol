...
contract TokensKeyPoolManagerTest is DeployHelper {
    ...
    function testTokensUpdateInterests() public {
        ...
        uint256 tokenBAmount = manager.balanceOf(address(lendingPoolManager), tokensKey.currency1.toId());
        uint256 positionId;
        ...
        uint256 mirrorBalance = mirrorTokenManager.balanceOf(address(lendingPoolManager), token1Id);
        tokenBAmount = manager.balanceOf(address(lendingPoolManager), tokensKey.currency1.toId());
